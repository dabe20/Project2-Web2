...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { description: @producto.description, estado: @producto.estado, name: @producto.name }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { description: @producto.description, estado: @producto.estado, name: @producto.name }
    assert_redirected_to producto_path(assigns(:producto))
  end
